...
class Processor():
    ...
    def load_data(self):
        print("Loading data")
        self.feeder = import_class(self.arg.feeder) #<dataset.dataloader_video.BaseFeeder object at 0x7f0332047610>
        ...
        for idx, (mode, train_flag) in enumerate(dataset_list):
            ...
            self.dataset[mode] = self.feeder(gloss_dict=self.gloss_dict, **arg) #<dataset.dataloader_video.BaseFeeder object at 0x7f0332047610>
            self.data_loader[mode] = self.build_dataloader(self.dataset[mode], mode, train_flag) #<torch.utils.data.dataloader.DataLoader object at 0x7f0332f94cd0>
